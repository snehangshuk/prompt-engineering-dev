...
| # | Topic | Time | Difficulty |
|---|-------|------|------------|
| [3.4](./activity-3.4-evaluation-templates.md) | Evaluation Template ⭐ | 30-40 min | ⭐⭐⭐⭐ Advanced |
...
#### Activity 3.4: Evaluation Template ⭐ (30-40 min)
- [ ] Complete `3.4-evaluation-templates.ipynb`
- [ ] Edit judge template in `activity-3.4-evaluation-templates.md`
...
- [Notebook 4: Evaluation Templates](../3.4-evaluation-templates.ipynb)
