# Activity 3.4: Create an Evaluation Template
...
1. Open `3.4-evaluation-templates.ipynb`
 ...
 *  
 *  Next step: Test it!
 *  Go to: 3.4-evaluation-templates.ipynb
...
- **Compare solutions**: Review `solutions/activity-3.4-evaluation-templates-solution.md` for the reference implementation
